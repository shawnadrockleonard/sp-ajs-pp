...
import {PrincipalType} from './peoplepicker-principaltype.ts';
...
export class PeoplePickerComponent {
    @Input() public principalType: PrincipalType
     ...
     * @param principalType
     */
    public SetPrincipalType(principalType: PrincipalType) {
    ...
    private HtmlEncode(html: string) {
        ...
        return elmHtmlA.innerHTML.ReplaceAll("'", "&apos;", false);
    };
